...
Instead, please report privately via [GitHub Security Advisories](https://github.com/niclaslindstedt/spotifai/security/advisories/new),
...
In scope: any vulnerability in the published release of spotifai.
