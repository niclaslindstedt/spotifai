...
// website/src/hooks/useTerminalAnimation.ts — keep this file in sync
// with zag's upstream so improvements (e.g. jitter tuning, generation
// counter fixes) flow across both projects.
